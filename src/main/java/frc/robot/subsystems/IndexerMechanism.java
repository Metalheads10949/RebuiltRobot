...
public class IndexerMechanism extends SubsystemBase {
  ...
  .withFeedforward(new SimpleMotorFeedforward(0.4, .12, 0))
  .withSimFeedforward(new SimpleMotorFeedforward(0.205, 0, 0))
  ...
  public Command setVoltage(double volts) {return indexer.setVoltage(Volts.of(volts));}
